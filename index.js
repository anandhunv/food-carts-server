...
mongoose.connect(`mongodb+srv://${process.env.DB_USER}:${process.env.DB_PASS}@food-order-app.5pjk3.mongodb.net/food-client?retryWrites=true&w=majority&appName=food-order-app`)
